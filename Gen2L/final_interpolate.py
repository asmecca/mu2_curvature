...
if mu == 0.0 :
    filename= "interpolate/boot_gen2l_zero.dat"
    f=open(filename,'r')
else:
    filename= f"interpolate/boot_gen2l_full_mu_{mu}.dat"
    f=open(filename,'r')
...
# Finding pseudocritical temperature as the point crossing the zero axis - bootstrap samples
